...
<head>
    ...
    <style>
        ...
        .btn-warning {
            background-color: #FFCDD2; /* ปุ่มแก้ไขสีแดงอ่อน */
            border-color: #FFABAB; /* สีแดงออกชมพู */
        }
        .btn-warning:hover {
            background-color: #FFABAB; /* เมื่อ hover ปุ่มจะเข้มขึ้น */
            border-color: #FFABAB;
        }
        .btn-success {
            background-color: #81C784; /* สีเขียว */
            border-color: #66BB6A; /* สีเขียวเข้ม */
        }
        .btn-success:hover {
        ...
        .btn-danger {
            background-color: #FF8A80; /* สีแดง */
            border-color: #FF5252; /* สีแดงเข้ม */
        }
        .btn-danger:hover {
